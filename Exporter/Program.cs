...
var uiTextureAtlas = new Dictionary<string, (int X, int Y, int Width, int Height, string Type)>(StringComparer.Ordinal)
{
  ...
  ["dialog"] = (0, 96, 16, 16, "ui"),
  ["dialog_purple"] = (16, 96, 16, 16, "ui"),
  ["dialog_pink"] = (32, 96, 16, 16, "ui"),
  ["dialog_yellow"] = (48, 96, 16, 16, "ui"),
  ["dialog_teal"] = (64, 96, 16, 16, "ui"),
  ["dialog_blue"] = (80, 96, 16, 16, "ui"),
  ["dialog_green"] = (112, 96, 16, 16, "ui"),
  ["dialog_red"] = (144, 96, 16, 16, "ui"),
